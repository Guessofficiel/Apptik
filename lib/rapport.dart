  ...
  Future<pw.Document> generatePdfReport() async {
    ...
    doc.addPage(pw.MultiPage(
      build: (context) => [
        ...
        pw.Text('👥 Statistiques des utilisateurs', style: pw.TextStyle(fontSize: 18)),
        ...
        pw.Text('🎫 Statistiques des tickets', style: pw.TextStyle(fontSize: 18)),
        pw.Bullet(text: 'En attente : $attente'),
        pw.Bullet(text: 'En cours : $enCours'),
        pw.Bullet(text: 'Résolus : $resolu'),

        pw.SizedBox(height: 20),
        pw.Paragraph(text: 'Fin du rapport. Généré automatiquement par l\'application APPTIK.'),
      ],
    ));
